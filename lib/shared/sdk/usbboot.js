 ...
 *
 * @param {Buffer} bootCodeBuffer - bootcode.bin buffer
 * @returns {Buffer} boot message buffer
 *
 * @example
 * const bootCodeBuffer = fs.readFileSync('bootcode.bin')
 * const bootMessageBuffer = createBootMessage(bootCodeBuffer)
 */
const createBootMessage = (bootCodeBuffer) => {
  ...
  bootMessageBuffer.writeInt32BE(bootCodeBuffer.length, BOOT_MESSAGE_BOOTCODE_LENGTH_OFFSET)
